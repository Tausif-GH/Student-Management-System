...
import javax.swing.*;
import java.sql.*;
public class AdAEdit extends Frame implements ActionListener, WindowListener
{
    public DataAccess da;
	private TextField tf,pf,t1,t2,t3,t4,t5;
	private Button backButton,na,s;
	private TextArea ta;
	private Frame parent;
    private Label y,x1,x2,x3,x4,x5;
	public AdAEdit(){
		super("Admin Edit Window");
		backButton=new Button("Back");
        na=new Button("Update Name");
		s=new Button("Update Salary");
        x1 = new Label("Name:");
        x3 = new Label("Salary:");
        x5 = new Label("Accountant ID");
		t1 = new TextField(22);
        t3 = new TextField(12);
        t5 = new TextField(4);
		...
		add(ta);
        add(x5);add(t5);add(x1);add(t1);add(na);add(x3);add(t3);add(s);
		add(backButton);
    ...
    public void editN(){
		try{
            String sql="update accountants set Name = '"+t1.getText()+"' where accountant.aID = '"+t5.getText()+"'";
    ...
    public void editS(){
		try{
            String sql="update accountants set Salary = '"+t3.getText()+"' where accountants.aID = '"+t5.getText()+"'";
			System.out.println(sql);
